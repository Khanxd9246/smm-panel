...
:root,[data-theme="dark"]{
  ...
  @if($__darkBase)     --c-base:{{ $__darkBase }};--c-surface:{{ $__darkBase }}ee;--c-topbar-bg:{{ $__darkBase }}cc; @endif
...
[data-theme="light"]{
  ...
  @if($__lightBase)    --c-base:{{ $__lightBase }};--c-surface:{{ $__lightBase }}ee;--c-topbar-bg:{{ $__lightBase }}ee; @endif
  @if($__lightCard)    --c-card:{{ $__lightCard }};--c-sidebar-bg:{{ $__lightCard }}f8; @endif
}
@endif
@if($__customFont)
body,input,select,textarea,button{font-family:'{{ $__customFont }}','Inter',sans-serif!important}
.brand-name{font-family:'{{ $__customFont }}','Inter',sans-serif!important}
@endif
@if($__borderRadius)
...
@endif
@if($__fontSize)
:root{--smm-fontsize:{{ $__fontSize }}}
body{font-size:var(--smm-fontsize)!important}
