...
<nav id="sidebar" class="hidden md:flex flex-col fixed left-0 top-0 h-full py-6 w-64 border-r border-white/5 bg-slate-950/80 backdrop-blur-md z-50 transition-transform duration-300">
    ...
    <div class="flex flex-col gap-1 mt-4 flex-grow font-inter text-sm font-medium px-3">
        ...
        @php
            $pendingDepositsCount = \App\Models\Transaction::where('status','pending')
        ...
        <div class="mt-4 pt-4 border-t border-white/5">
            ...
            {{-- Pending Deposits with live badge --}}
            <a href="{{ route('admin.transactions.index', ['status'=>'pending','type'=>'deposit']) }}"
               class="flex items-center justify-between px-4 py-3 rounded-lg {{ request()->routeIs('admin.transactions.*') ? 'bg-purple-500/10 text-purple-400' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5' }} transition-all hover:translate-x-1">
                <div class="flex items-center gap-4">
                    <span class="material-symbols-outlined text-[20px]">payments</span> Pending Deposits
                </div>
            ...
            <a href="{{ route('admin.users.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg {{ request()->routeIs('admin.users.*') ? 'bg-purple-500/10 text-purple-400' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5' }} transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">people</span> Users
            </a>
            <a href="{{ route('admin.orders.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg {{ request()->routeIs('admin.orders.*') ? 'bg-purple-500/10 text-purple-400' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5' }} transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">receipt_long</span> All Orders
            </a>
            {{-- AI Features section --}}
            <p class="text-[10px] text-slate-600 uppercase tracking-widest px-4 mb-1 mt-3 font-label-caps">AI Features</p>
            <a href="/admin/ai/services" class="flex items-center gap-4 px-4 py-3 rounded-lg text-slate-500 hover:text-purple-300 hover:bg-purple-500/5 transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">smart_toy</span> AI Services
            </a>
            <a href="/admin/ai/pricing" class="flex items-center gap-4 px-4 py-3 rounded-lg text-slate-500 hover:text-purple-300 hover:bg-purple-500/5 transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">price_change</span> AI Pricing
            </a>
            <a href="/admin/ai/suppliers/health" class="flex items-center gap-4 px-4 py-3 rounded-lg text-slate-500 hover:text-purple-300 hover:bg-purple-500/5 transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">monitor_heart</span> Supplier Health
            </a>
            <a href="/admin/ai/quality/low" class="flex items-center gap-4 px-4 py-3 rounded-lg text-slate-500 hover:text-purple-300 hover:bg-purple-500/5 transition-all hover:translate-x-1">
                <span class="material-symbols-outlined text-[20px]">grade</span> Quality Scores
            </a>
        </div>
        @endif
    </div>
