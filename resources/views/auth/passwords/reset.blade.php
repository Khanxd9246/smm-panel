...
<title>Reset Password — {{ config('app.name','SMM Elite') }}</title>
...
<div style="width:100%;max-width:420px;position:relative;z-index:1;" class="fade-up">
    ...
    <div class="glass-card" style="border-radius:20px;padding:2rem;">
        ...
        <h2 style="font-size:18px;font-weight:700;color:#dae2fd;margin-bottom:8px;">Reset Your Password</h2>
        <p style="font-size:13px;color:#8c909f;margin-bottom:24px;">Enter your new password below.</p>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div style="margin-bottom:16px;">
                <label style="display:block;font-size:11px;font-weight:600;color:#8c909f;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;font-family:'Space Grotesk',sans-serif;">New Password</label>
                <input type="password" name="password" class="glass-input" placeholder="••••••••" required>
            </div>

            <div style="margin-bottom:24px;">
                <label style="display:block;font-size:11px;font-weight:600;color:#8c909f;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;font-family:'Space Grotesk',sans-serif;">Confirm Password</label>
                <input type="password" name="password_confirmation" class="glass-input" placeholder="••••••••" required>
            </div>
            ...
            <button type="submit" style="width:100%;background:linear-gradient(135deg,#4d8eff,#adc6ff);color:#002e6a;border:none;border-radius:12px;padding:14px;font-size:14px;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 0 20px rgba(173,198,255,0.25);transition:all 0.2s;" onmouseover="this.style.filter='brightness(1.1)'" onmouseout="this.style.filter='brightness(1)'">
                <span class="material-symbols-outlined" style="font-size:18px;">lock</span> Reset Password
            </button>
        </form>

        <div style="text-align:center;margin-top:20px;font-size:13px;color:#8c909f;">
            <a href="{{ route('login') }}" style="color:#adc6ff;font-weight:600;text-decoration:none;">← Back to sign in</a>
        </div>
    </div>
